...
float shadow_strength : hint_range(0.0, 1.0, 0.01) = 0.4
float highlight_strength : hint_range(0.0, 1.0, 0.01) = 0.1
Vector3 highlight_color : source_color = vec3(1.)
Vector3 shadow_color : source_color = vec3(0.0)
