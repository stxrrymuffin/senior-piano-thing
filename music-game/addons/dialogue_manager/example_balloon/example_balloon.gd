...
@onready var char_portrait: AnimatedSprite2D = $Portrait
...
func apply_dialogue_line() -> void:
	...
	if $Portrait.sprite_frames.has_animation(dialogue_line.character.to_lower()):
		$Portrait.play(dialogue_line.character.to_lower())
	else:
		$Portrait.play("default")
	var tween = create_tween()
	tween.tween_property($Portrait, "position", $Portrait.position + Vector2(0, -10), 0.15)
